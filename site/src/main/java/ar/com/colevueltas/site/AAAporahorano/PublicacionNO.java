...
public class PublicacionNO {
    ...
    public PublicacionNO(int id, String titulo, String descripcion, LocalDate publicacion, Double precio, Estado estado, Double descuento, int id_cat, int id_col, int id_usu, int id_anio) {
        this.id = id;
        this.titulo = titulo;
        this.descripcion = descripcion;
